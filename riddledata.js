...
const RIDDLES = [
  ...
  {
    id: 36,
    name: "Full of problems",
    difficulty: "easy",
    lines: [
      "'It' has problems regarding the money,",
      "Though you're not a bank, but you have to solve,",
      "'It' has problems about time and work,",
      "true, not an assistant, yet you have to solve,",
      "'It' has problems measuring the distances,",
      "there exists G-maps, but still you have to solve,",
      "Whether any need or not, that here does'nt matter,",
      "what is 'it' for which, you have so much to solve?",
    ],
